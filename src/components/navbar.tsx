...
export default function Navbar() {
  ...
  return (
    <nav className="navbar-main flex flex-row justify-between items-end w-screen mt-3 py-3 select-none px-8 md:px-12 z-10">
      <div className="logo  text-accent3
      d font-quicksand font-bold ">
